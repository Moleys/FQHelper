...
public final class SPUtils {
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils getInstance(final Context context) {
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils getInstance(final Context context,String spName) {
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils getInstance(final Context context,String spName, final int mode) {
